...
nbtscan
gethostbyname
nmblookup -A 10.19.30.17
netstat -a 10.16.214.60
route
rlogin
...
#1. start the server. thus return the local host name
sudo apachectl -k start
#2. open Web share
#Open Web Share in system configure.
#notes:
#configure file: /etc/apache2/httpd.conf
#host web work path: /Library/WebServer/Documents
#self web work path: ~/Sites/
